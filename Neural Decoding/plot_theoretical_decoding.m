function plot_theoretical_decoding(ds, m, decoding_results)
...
for rep=1:50
    ...
    for timebin=1:timebins
        ...
        geom13 = extract_geometry([X1;X3]);
        geom24 = extract_geometry([X2;X4]);
        
        snr_A = SNR(geom13, geom24);
        snr_B = SNR(geom24, geom13);
