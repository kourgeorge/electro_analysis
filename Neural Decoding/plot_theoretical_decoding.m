...
figure;
hold on;
plot(1:timebins, [theoretical_acc, theoretical_acc_mat], '--', 'LineWidth',2)
legend('Theory Accuracy', ['Theory recall', num2str(labels(1))], ['Theory recall', num2str(labels(2))],'AutoUpdate','off');
...
if nargin>1
    ...
    legend('Theory Accuracy', ['Theory recall', num2str(labels(1))], ['Theory recall', num2str(labels(2))],...
        'Empirical Accuracy', ['Empirical recall', num2str(labels(1))], ['Empirical recall', num2str(labels(2))],'AutoUpdate','off')
end
