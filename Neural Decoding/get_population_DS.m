function ds = get_population_DS(rastersDir, event, stage, label, numSplits, binSize,  stepSize, train_label_values, test_label_values)
...
%Only a single repetition is enough due to the noverl augmentation
%technique.
