function snrObj = SNR(geomA, geomB)
...
snrObj.snr = snr;
snrObj.error = error_a;
snrObj.signal=signal; 
snrObj.bias=bias;
snrObj.dim=dim;
snrObj.signal_noise_overlapA = signal_noise_overlapA; 
snrObj.signal_noise_overlapB= signal_noise_overlapB;
snrObj.noise_noise = noise_noise;
